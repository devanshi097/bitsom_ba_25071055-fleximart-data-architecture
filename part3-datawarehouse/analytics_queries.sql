...
-- Demonstrates drill-down using date dimension
-- =====================================================
...
-- NOTE:
-- Output depends on warehouse data.
-- In the current dataset, all customers fall into the 'High Value' segment.
-- Query logic correctly supports all three segments when data permits.
